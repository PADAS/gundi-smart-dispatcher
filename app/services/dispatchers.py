...
class SmartConnectDispatcherV2(DispatcherV2, ABC):
    ...
    def __init__(
        ...
        self.smart_client = AsyncSmartClient(
            api=f"{url_parse.scheme}://{url_parse.hostname}/server" or auth_config.endpoint,
...
class SmartConnectEventDispatcher(SmartConnectDispatcherV2):
    ...
    def __init__(
        ...
        self.push_config = schemas.v2.SMARTPushEventActionConfig.parse_obj(push_events_config.data)
